...
from machineLearning.make_chat_prediction import emotion_prediction_class
from machineLearning import negation_detection
from machineLearning.goemotions_configuration_constant import ML_INFLUENCED_CHAT_OUTPUT, ML_NEGATIVE_SENTIMENT_LIST,ML_POSTIVE_SENTIMENT_LIST
...
class Eliza:
    ...
    def run(self):
        ...
        while True:
            sent = input('> ')
            # Call the ML model here and detection mood is negative or not then return output acordingly.
            chat_prediction = emotion_prediction_class(sent)
            emotion_detection_result = chat_prediction.make_emotion_prediction()
            print("***========DEBUG=========*** emotion detection result is :", emotion_detection_result)
